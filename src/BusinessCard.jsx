    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8f4f1] p-4">
      <div className="max-w-md w-full p-6 rounded-2xl shadow-lg bg-[#fffaf9]">
        ...
        <div className="text-center">
          <img src="/Headshot.JPG" alt="Tiffany Burchfield" className="w-32 h-40 mx-auto mb-4 object-contain" />
	...
	<div className="flex items-center space-x-3">
 	  ...
 	  <a href="https://www.instagram.com/mylendertiffany" className="text-[#a96c65] hover:underline">
        ...
        <div className="flex items-center space-x-3 mt-2">
          <Globe className="w-5 h-5 text-[#a96c65]" />
